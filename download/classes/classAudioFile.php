...
{
print '<b>Информация о песне:</b><br/>
Каналы: '.$this->wave_channels.'<br/>
Частота: '.$this->wave_framerate.' Гц<br/>
Битрейт: '.$this->wave_byterate.'<br/>
...
print 'Артист: '.$artist.'<br/>';
}
if($album = repl(trim($this->id3_album))){
print 'Альбом: '.$album.'<br/>';
}
...
if($comment = repl(trim($this->id3_comment))){
